class Song:
    ...
    def __init__(self, title, artist, duration=0):
        ...
        #     artist(Artist): At artist object representing songs creator
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            # elif new_artist.name != artist_field:
                ...
                # store the current album in the currents artist collection then create a new artist object ---modified
            ...
            # create a new song object and added to the current album's collection
...
def create_checkfile(artist_list):
    ...
    with open("file3.txt", 'w') as checkfile:
